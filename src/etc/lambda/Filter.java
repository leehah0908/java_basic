...
public class Filter {
    ...
    /**
     * @solution - try1: 사과 바구니에서 녹색 사과만 필터링
     * @param1: 전체 사과가 들어있는 바구니
     * @return: 녹색 사과만 필터링된 바구니
     * @problem: 다른 색상의 사과를 필터링 해야 한다면?? -> 새로운 메서드를 계속 선언해야 함
     */
    ...
    /**
     * @solution - try2: 색상을 파라미더화 하기
     * @problem - 만약 필터 기준이 색상이 아니라 무게라면? -> 새로운 메서드를 계속 선언해야 함
     */
