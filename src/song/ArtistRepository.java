...
import static song.Utility.FILE_PATH;
...
public class ArtistRepository {
    ...
    기존 가수 정보에 노래만 추가하는 기능
        - artistName - 사용자의 입력 가수 이름
        - songName   - 사용자의 입력 노래 이름
        - 곡명이 중복되었다면 false,
    ...
    public void loadData() {
        ...
        if (file.exists()) {
            try (FileInputStream fos = new FileInputStream(FILE_PATH + "/song.sav")) {
            ...
            System.out.printf("세이브 파일이 없습니다.");
        }
    }
}
